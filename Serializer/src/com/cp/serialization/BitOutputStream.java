...
public class BitOutputStream extends OutputStream {
	 ...
	 * using a variable number of bits, with a smaller number used to represent smaller numbers<p>
	 * 
	 * 0 is represented as a single bit 0, with other numbers represented with
	 * a sign bit and various header depending on the range the number fits in:<p>
	 * 
	 * if value is positive <br>
	 * 100 --> 1  <br>
	 * 1010 --> byte next is value (0-255) <br>
	 * 10110 --> next 2 bytes are value (0-65535) <br>
	 * 101110 --> next 4 bytes are value (0-4294967295) <br>
	 * 101111 --> next 8 bytes are value (any remaining number)<p>
	 * 
	 * if value is negative <br>
	 * 110 --> 1  <br>
	 * 1110 --> byte next is value (0-255) <br>
	 * 11110 --> next 2 bytes are value (0-65535) <br>
	 * 111110 --> next 4 bytes are value (0-4294967295) <br>
	 * 111111 --> next 8 bytes are value (any remaining number)<p>
	 * 
	 ...
	 * current byte for the sake of ensuring the next data is byte aligned. <p>
	 * 
